...
export function ExpenseForm({
  ...
  const defaultExpenseDate = React.useMemo(
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSubmit({
      ...
      recurring_day: formData.is_recurring
        ? parseInt(formData.recurring_day) || undefined
        : undefined,
    });
    onOpenChange(false);
  };
          ...
          {formData.is_recurring && (
            <FormField label="Recurring Day">
              <Select
                ...
                onValueChange={(value) =>
                  setFormData({ ...formData, recurring_day: value })
                }
