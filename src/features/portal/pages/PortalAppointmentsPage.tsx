  ...
  return (
    <div className="min-h-screen bg-slate-50 p-4 text-slate-900">
      ...
      <div className="mt-5 space-y-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        <div>
          <span className="mb-2 block text-sm font-medium">Pilih Hewan</span>
        ...
        <div>
          <label htmlFor="portal-appointment-date" className="mb-2 block text-sm font-medium">Tanggal</label>
          <input
            id="portal-appointment-date"
            type="date"
        ...
        <div>
          <span className="mb-2 block text-sm font-medium">Jam</span>
        ...
        <button
          type="button"
          className="w-full rounded-xl bg-primary-600 px-4 py-2.5 font-medium text-white"
        >
          Booking Baru
        </button>
      </div>
