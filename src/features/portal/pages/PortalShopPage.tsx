  ...
  return (
    <div className="min-h-screen bg-slate-50 p-4 text-slate-900">
      ...
      <p className="mt-2 text-sm text-slate-600">
        Belanja kebutuhan hewan peliharaan dengan checkout yang mudah.
      </p>
      ...
      <div className="mt-5 grid gap-4 sm:grid-cols-2">
        {["Whiskas", "Vitamin", "Makanan Kering", "Toys"].map((item) => (
          ...
          >
            ...
            <button
              type="button"
              className="mt-3 w-full rounded-xl border border-primary-200 bg-primary-50 px-3 py-2 text-sm font-medium text-primary-700"
            >
              + Keranjang
            </button>
          </div>
