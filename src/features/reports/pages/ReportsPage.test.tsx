  ...
  beforeEach(() => {
    mockUseQuery.mockImplementation(({ queryKey }) => {
      if (queryKey[0] === 'customers') {
        return { data: [{ id: '1' }, { id: '2' }, { id: '3' }], isLoading: false, error: null }
      }

      if (queryKey[0] === 'pets') {
        return { data: [{ id: '1' }, { id: '2' }, { id: '3' }, { id: '4' }], isLoading: false, error: null }
      }

      if (queryKey[0] === 'appointments') {
        return { data: [{ id: 'a1' }, { id: 'a2' }], isLoading: false, error: null }
      }
